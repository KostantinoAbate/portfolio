...
return [
    'landing-slide' => [
        'text' => 'Mi chiamo Kostantino Abate e sono uno sviluppatore <span class="ka-highlight">Full-stack</span> con una forte passione per il design funzionale e il codice pulito.
            Mi occupo di Software e Web development, creando soluzioni moderne e scalabili per aziende e progetti indipendenti.'
    ],
    'about-slide' => [
        'start' => 'Mi chiamo Kostantino Abate e sono uno sviluppatore Full-stack con una forte passione per lo <span class="ka-highlight">sviluppo software</span>, il design funzionale e le soluzioni digitali su misura.
        ...
        'end' => 'Nel corso del tempo ho collaborato a progetti che spaziano da gestionali personalizzati a <span class="ka-highlight">piattaforme complesse</span>, adattandomi a diversi contesti e obiettivi.
    ...
    'contact-slide' => [
        'text' => '<a href="mailto:kostantinoabate.dev@gmail.com" class="link link-hover ka-highlight">Lavoriamo insieme!</a> Se hai un progetto in mente o cerchi un full-stack developer affidabile e creativo, contattami: sarò felice di ascoltarti.'
    ],
    'project-slide' => [
        'text' => '<a href="#" class="link link-hover ka-highlight">Clicca qui</a> per esplorare la lista completa dei progetti a cui ho preso parte, tra applicazioni web, gestionali, interfacce dinamiche e soluzioni personalizzate.
